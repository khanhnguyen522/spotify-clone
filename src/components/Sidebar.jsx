...
{/* onClick in NavLinks BELOW -> USE FOR MOBILE, IF CLICK 
1 OF BARSIDE THEN MOBILE BARSIDE DISAPPEAR */}
...
const Sidebar = () => {
  ...
  return (
    <>
      {/* THIS DIV IS APPEARED ON DESKTOP NOT MOBILE */}
      ...
      {/* THE ACTUAL MENU INSIDE MOBILE ICON ON THE TOP-RIGHT */}
