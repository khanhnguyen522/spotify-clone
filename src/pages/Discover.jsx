...
const Discover = () => {
    ...
    {/* USE useSelector TO CHOOSE SLICE FROM A BIG CAKE 
(slice in cake in playerSlice.js) */}
    const { activeSong, isPlaying, genreListId } = useSelector((state) => state.player);

    const { data, isFetching, error } = useGetSongsByGenreQuery(genreListId || 'POP');
    

    {/* SEE THE ARRAY OF %) SONGS IN CONSOLE LOG */}
    {/* console.log(data)*/}

    {/* Check for data?.map below */}
